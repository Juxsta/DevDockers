...
Welcome to ``DevDockers`` contributor's guide.
...
If you experience bugs or general issues with ``DevDockers``, please have a look
...
You can help improve ``DevDockers`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``DevDockers`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``DevDockers``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n DevDockers python=3 six virtualenv pytest pytest-cov
    conda activate DevDockers
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/DevDockers.git
    cd DevDockers
...
#. Install |pre-commit|_::
   ...
   ``DevDockers`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/DevDockers
.. _issue tracker: https://github.com/<USERNAME>/DevDockers/issues
.. <-- end -->
